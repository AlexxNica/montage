...
var ObjectDescriptor = require("./blueprint").ObjectDescriptor;
        ...
        value: function (moduleId, _require) {
            ...
            return BLUEPRINT_CACHE[key] = _require.async(moduleId)
                .then(function (object) {
                    ...
                    objectDescriptor.objectDescriptorModuleId = new ModuleReference().initWithIdAndRequire(moduleId, _require);
